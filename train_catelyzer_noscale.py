...
dir_checkpoint = Path('./checkpoints/Aug_1.0scale/')
...
def train_model(
    ...
    # tra_prefetcher = CPUPrefetcher(train_loader)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if save_checkpoint and epoch % 10 == 0:
            ...
            torch.save(state_dict, str(dir_checkpoint / 'Aug_epoch{}.pth'.format(epoch)))
...
def get_args():
    ...
    parser.add_argument('--batch-size', '-b', dest='batch_size', metavar='B', type=int, default=96, help='Batch size')
    parser.add_argument('--work_num', '-w', dest='work_num', type=int, default=16, help='work numbers')
    parser.add_argument('--learning-rate', '-l', metavar='LR', type=float, default=1e-5,
                        help='Learning rate', dest='lr')
    parser.add_argument('--load', '-f', type=str, default=False, help='Load model from a .pth file')    # load
